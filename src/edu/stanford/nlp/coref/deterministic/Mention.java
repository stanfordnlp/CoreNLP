...
//    }
  ...
  protected ArrayList<String> getSingletonFeatures(Dictionaries dict){
    ...
    int personNum = 3;
    if(person.equals(Dictionaries.Person.I) || person.equals(Dictionaries.Person.WE)) personNum = 1;
    if(person.equals(Dictionaries.Person.YOU)) personNum = 2;
    if(person.equals(Dictionaries.Person.UNKNOWN)) personNum = 0;
  ...
  private void setPerson(Dictionaries dict) {
    // only do for pronoun
    if(!this.isPronominal()) person = Dictionaries.Person.UNKNOWN;
    ...
    if(dict.firstPersonPronouns.contains(spanToString)) {
      ...
      } else if (number == Dictionaries.Number.PLURAL) {
      ...
      } else if (gender == Dictionaries.Gender.FEMALE && number == Dictionaries.Number.SINGULAR) {
        person = Dictionaries.Person.SHE;
      } else if ((gender == Dictionaries.Gender.NEUTRAL || animacy == Dictionaries.Animacy.INANIMATE) && number == Dictionaries.Number.SINGULAR) {
  ...
  public boolean isListMemberOf(Mention m) {
    ...
    if (m.mentionType == Dictionaries.MentionType.LIST && this.mentionType == Dictionaries.MentionType.LIST) return false; // Don't handle nested lists
...
//    }
  ...
  protected void setNumber(Dictionaries dict) {
    ...
    } else if (mentionType == Dictionaries.MentionType.LIST) {
      number = Dictionaries.Number.PLURAL;
    } else if(! nerString.equals("O") && mentionType!= Dictionaries.MentionType.NOMINAL){
  ...
  private boolean numbersAgree(Mention m, boolean strict) {
    if (strict) {
      ...
      return number == Dictionaries.Number.UNKNOWN ||
  ...
  public boolean gendersAgree(Mention m, boolean strict) {
    if (strict) {
      ...
      return gender == Dictionaries.Gender.UNKNOWN ||
  ...
  public boolean animaciesAgree(Mention m, boolean strict) {
    if (strict) {
      ...
      return animacy == Dictionaries.Animacy.UNKNOWN ||
  ...
  protected boolean isTheCommonNoun() {
    if (this.mentionType == Dictionaries.MentionType.NOMINAL
  ...
  public boolean isRoleAppositive(Mention m, Dictionaries dict) {
    ...
    if (!animaciesAgree(m) || this.animacy == Dictionaries.Animacy.INANIMATE
         || this.gender == Dictionaries.Gender.NEUTRAL || m.gender == Dictionaries.Gender.NEUTRAL
         || !this.numbersAgree(m)) {
      return false;
    }
