...
public class Rules {
  ...
  public static boolean entityAlias(CorefCluster mentionCluster, CorefCluster potentialAntecedent,
    ...
    if(mention.mentionType!= Dictionaries.MentionType.PROPER
        || antecedent.mentionType!= Dictionaries.MentionType.PROPER) return false;
  ...
  public static boolean entityIsApposition(CorefCluster mentionCluster, CorefCluster potentialAntecedent, Mention m1, Mention m2) {
    if(!entityAttributesAgree(mentionCluster, potentialAntecedent)) return false;
    if(m1.mentionType== Dictionaries.MentionType.PROPER && m2.mentionType== Dictionaries.MentionType.PROPER) return false;
  ...
  public static boolean entityRelaxedExactStringMatch(
    ...
    if(mention.mentionType == Dictionaries.MentionType.LIST || ant.mentionType == Dictionaries.MentionType.LIST) return false;
  ...
  public static boolean entityPersonDisagree(Document document, Mention m, Mention ant, Dictionaries dict) {
    ...
    if(sameSpeaker && m.person!=ant.person) {
      if ((m.person == Dictionaries.Person.IT && ant.person == Dictionaries.Person.THEY)
           || (m.person == Dictionaries.Person.THEY && ant.person == Dictionaries.Person.IT) || (m.person == Dictionaries.Person.THEY && ant.person == Dictionaries.Person.THEY)) {
        return false;
      } else if (m.person != Dictionaries.Person.UNKNOWN && ant.person != Dictionaries.Person.UNKNOWN)
        return true;
    }
    if(sameSpeaker) {
      if(!ant.isPronominal()) {
        if(m.person== Dictionaries.Person.I || m.person== Dictionaries.Person.WE || m.person== Dictionaries.Person.YOU) return true;
      } else if(!m.isPronominal()) {
        if(ant.person== Dictionaries.Person.I || ant.person== Dictionaries.Person.WE || ant.person== Dictionaries.Person.YOU) return true;
      }
    }
    ...
    } else if (ant.person== Dictionaries.Person.YOU && m != ant && m.appearEarlierThan(ant)) {
  ...
  public static boolean entityClusterAllCorefDictionary(CorefCluster menCluster, CorefCluster antCluster,
   ...
   public static boolean sentenceContextIncompatible(Mention men, Mention ant, Dictionaries dict) {
     if ( (ant.mentionType != Dictionaries.MentionType.PROPER)
          && (ant.sentNum != men.sentNum)
          && (men.mentionType != Dictionaries.MentionType.PROPER)
          && !isContextOverlapping(ant,men)) {
