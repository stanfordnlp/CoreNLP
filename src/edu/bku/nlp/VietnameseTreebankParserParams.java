...
/**
 * Parser parameters for the Penn Vietnamese Treebank based on EnglishTreebankParserParams code
 *
 * @author Hoang Nguyen
 * @version 09/03/2017
 */
...
public class VietnameseTreebankParserParams extends AbstractTreebankParserParams  {
  ...
  private static Redwood.RedwoodChannels log = Redwood.channels(VietnameseTreebankParserParams.class);

  protected class VietnameseSubcategoryStripper implements TreeTransformer {
  ...
  public VietnameseTreebankParserParams() {
    super(new VietnamesePennTreebankLanguagePack());
    headFinder = new VietnameseHeadFinder(tlp);
  }
  ...
  public TreeTransformer subcategoryStripper() {
    return new VietnameseSubcategoryStripper();
  }
  ...
  public static void main(String[] args) {
    TreebankLangParserParams tlpp = new VietnameseTreebankParserParams();
  ...
  private static final long serialVersionUID = 5153878351331522581L;
