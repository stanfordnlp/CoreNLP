...
public class SemanticHeadFinder extends ModCollinsHeadFinder {
  ...
  static final String[] copulaVerbs = {"be", "being", "been", "am", "are", "r", "is", "ai", "was", "were", "'m", "m", "ar", "art", "'re", "'s", "s", "wase", "seem", "seems", "seemed", "seeming", "appear", "appears", "appeared", "stay", "stays", "stayed", "remain", "remains", "remained", "resemble", "resembles", "resembled", "resembling", "become", "becomes", "became", "becoming"};
