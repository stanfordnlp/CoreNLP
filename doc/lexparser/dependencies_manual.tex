...
has been used to evaluate dependency parsers in the 2012 shared task on parsing the web \citep{Petrov12}.
...
\item[abbrev] was removed as a relation.  It is now a particular case
  of an \emph{appos}.
\item[compl] was removed as a relation. It is now a particular case of
