...
The first five items in the below list use the Stanford CoreNLP server that we've developed over the last couple of years. You should probably use one of them. Further down in the list are some other utilities and frameworks and last generation interfaces.
