...
public enum Operator {
  ...
  NUM("__num__",                                     FORWARD_ENTAILMENT, "anti-additive", "multiplicative"),  // TODO check me
  NUM_NUM("__num__ __num__",                         FORWARD_ENTAILMENT, "anti-additive", "multiplicative"),  // TODO check me
  NUM_NUM_NUM("__num__ __num__ __num__",             FORWARD_ENTAILMENT, "anti-additive", "multiplicative"),  // TODO check me
  NUM_NUM_NUM_NUM("__num__ __num__ __num__ __num__", FORWARD_ENTAILMENT, "anti-additive", "multiplicative"),  // TODO check me
  ...
  LESS_THAN("less than __num__",   FORWARD_ENTAILMENT, "additive", "additive"),
  SOME_OF("some of",               FORWARD_ENTAILMENT, "additive", "additive"),
  ONE_OF("one of",                 FORWARD_ENTAILMENT, "additive", "additive"),
  AT_LEAST("at least __num__",     FORWARD_ENTAILMENT, "additive", "additive"),
  ...
  NUM_OF_THE("__num__ of the",     FORWARD_ENTAILMENT, "additive", "additive"),
  ...
  JUST_NUM("just __num__",      FORWARD_ENTAILMENT, "nonmonotone", "multiplicative"),
  ONLY_NUM("only __num__",      FORWARD_ENTAILMENT, "nonmonotone", "multiplicative"),

  // Strange cases
  AT_MOST_NUM("at most __num__", FORWARD_ENTAILMENT, "anti-additive", "anti-additive"),
  ;
  ...
  public static Optional<Operator> fromString(String word) {
    String wordToLowerCase = word.toLowerCase().replaceAll("[0-9]", "__num__ ").trim();
