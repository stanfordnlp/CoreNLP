...
$ java -Xmx30g edu.stanford.nlp.coref.train.CorefTrainer -props <PROPERTIES_FILE> >& log-train.txt

How to evaluate the system
$ java -Xmx30g edu.stanford.nlp.coref.CorefSystem -props <PROPERTIES_FILE> >& output.txt
