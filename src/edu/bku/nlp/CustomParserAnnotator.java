 ...
 * @author Hoang Nguyen
 */
public class CustomParserAnnotator extends SentenceAnnotator  {

  /** A logger for this class */
  private static final Redwood.RedwoodChannels log = Redwood.channels(CustomParserAnnotator.class);
  ...
  public CustomParserAnnotator(ParserGrammar parser, boolean verbose, int maxSent) {
    this(parser, verbose, maxSent, null);
  }

  public CustomParserAnnotator(ParserGrammar parser, boolean verbose, int maxSent, Function<Tree, Tree> treeMap) {
  ...
  public CustomParserAnnotator(String annotatorName, Properties props) {
