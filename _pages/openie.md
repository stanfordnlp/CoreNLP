...
```bash
java -mx1g -cp stanford-corenlp-<version>.jar:stanford-corenlp-models-<version>.jar:CoreNLP-to-HTML.xsl:* edu.stanford.nlp.naturalli.OpenIE
```
...
```bash
java -mx1g -cp stanford-corenlp-<version>.jar:stanford-corenlp-models-<version>.jar:CoreNLP-to-HTML.xsl:* edu.stanford.nlp.naturalli.OpenIE  /path/to/file1  /path/to/file2 
```
...
```bash
java -mx1g -cp stanford-corenlp-<version>.jar:stanford-corenlp-models-<version>.jar:CoreNLP-to-HTML.xsl:* edu.stanford.nlp.naturalli.OpenIE  -filelist /path/to/filelist
```
