...
public class EntityMentionsAnnotatorITest {
  ...
  public void testBasicMentions() {
    ...
    String[] expectedMentions = {
        ...
        "[Text=Albert Peacock CharacterOffsetBegin=29 CharacterOffsetEnd=43 Tokens=[Albert-6, Peacock-7] TokenBegin=5 TokenEnd=7 NamedEntityTag=PERSON EntityType=PERSON SentenceIndex=0 EntityMentionIndex=1 CanonicalEntityMentionIndex=1 NamedEntityTagProbs={PERSON=0.9917586256159676}]"
    };
  ...
  public void testNewsText() {
    ...
    String[] expectedMentions = {
        ...
        "[Text=William CharacterOffsetBegin=26 CharacterOffsetEnd=33 Tokens=[William-6] TokenBegin=5 TokenEnd=6 NamedEntityTag=PERSON EntityType=PERSON SentenceIndex=0 EntityMentionIndex=2 CanonicalEntityMentionIndex=2 NamedEntityTagProbs={PERSON=0.9741648846625593}]",
        ...
        "[Text=University of Oxford CharacterOffsetBegin=70 CharacterOffsetEnd=90 Tokens=[University-15, of-16, Oxford-17] TokenBegin=14 TokenEnd=17 NamedEntityTag=ORGANIZATION EntityType=ORGANIZATION SentenceIndex=0 EntityMentionIndex=4 CanonicalEntityMentionIndex=4 NamedEntityTagProbs={ORGANIZATION=0.9997148342563612}]",
