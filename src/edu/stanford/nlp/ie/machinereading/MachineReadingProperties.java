...
public class MachineReadingProperties {
  ...
  @Option(name="testUsePipelineNER", gloss="during testing/evaluation, use NER generated by the CoreNLP pipeline")
  static protected boolean testUsePipelineNER = false;
