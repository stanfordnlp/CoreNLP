...
* Download and unzip [CoreNLP 4.5.1](https://nlp.stanford.edu/software/stanford-corenlp-4.5.1.zip) [(HF Hub)](https://huggingface.co/stanfordnlp/CoreNLP/tree/main)
...
```bash
mv /path/to/stanford-corenlp-4.5.1-models-french.jar /path/to/stanford-corenlp-4.5.1
```

* Include the distribution directory in your CLASSPATH.

```bash
export CLASSPATH=$CLASSPATH:/path/to/stanford-corenlp-4.5.1/*:
```
