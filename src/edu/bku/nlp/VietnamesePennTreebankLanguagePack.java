 ...
 * parsing the Vietnamese Penn Treebank. This code base on PennTreebankLanguagePack
 *
 * @author Hoang Nguyen
 */
public class VietnamesePennTreebankLanguagePack extends AbstractTreebankLanguagePack {

  /**
   * Gives a handle to the TreebankLanguagePack
   */
  public VietnamesePennTreebankLanguagePack() {
  }
  ...
  public static void main(String[] args) {
    TreebankLanguagePack tlp = new VietnamesePennTreebankLanguagePack();
