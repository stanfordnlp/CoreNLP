...
public class BisequenceCRFClassifier<IN extends CoreMap> {
  ...
  public void classifyAndWriteAnswers() throws IOException {
    ...
    System.err.println("\nStart sampling");
    timer.start();
    ThreadsafeProcessor<Quadruple<List<IN>, List<IN>, List<Triple<Integer, Integer, Double>>, List<List<Integer>>>, Pair<List<IN>, List<IN>>> threadProcessor = 
        new ThreadsafeProcessor<Quadruple<List<IN>, List<IN>, List<Triple<Integer, Integer, Double>>, List<List<Integer>>>, Pair<List<IN>, List<IN>>>() {
      @Override
      public Pair<List<IN>, List<IN>> process(Quadruple<List<IN>, List<IN>, List<Triple<Integer, Integer, Double>>, List<List<Integer>>> quad) {
      ...
      @Override
      public ThreadsafeProcessor<Quadruple<List<IN>, List<IN>, List<Triple<Integer, Integer, Double>>, List<List<Integer>>>, Pair<List<IN>, List<IN>>> newInstance() {
        return this;
      }
    };
