...
* [*CoreNLP XML*](https://github.com/relwell/corenlp-xml-lib), a library responsible for handling interactions with CoreNLP's XML output by Robert Elwell. Available on [PyPI](https://pypi.python.org/pypi/corenlp-xml).
